#include "lua/lua_fairygui_auto.hpp"
#include "FairyGUI.h"
#include "FairyGUIMacros.h"
#include "scripting/lua-bindings/manual/tolua_fix.h"
#include "scripting/lua-bindings/manual/LuaBasicConversions.h"
#include "lua/LuaBasicConversions_fairygui.h"

int lua_fairygui_UIConfig_registerFont(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_fairygui_UIConfig_getRealFontName(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIConfig_getRealFontName'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_UIConfig_getRealFontName'.",&tolua_err);
#endif
    return 0;
}
static int lua_fairygui_UIConfig_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (UIConfig)");
    return 0;
}

int lua_register_fairygui_UIConfig(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"UIConfig");
        ...
        tolua_function(tolua_S,"getRealFontName", lua_fairygui_UIConfig_getRealFontName);
...
int lua_fairygui_InputEvent_getTouchId(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getTouchId'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getProcessor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getProcessor'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getButton(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getButton'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_isDoubleClick(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_isDoubleClick'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getTouch(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getTouch'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_isAltDown(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_isAltDown'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getTarget(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getTarget'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getX(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getX'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getY(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getY'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getMouseWheelDelta(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getMouseWheelDelta'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_isShiftDown(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_isShiftDown'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_isCtrlDown(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_isCtrlDown'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getKeyCode(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getKeyCode'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_getPosition(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_getPosition'", nullptr);
            return 0;
        }
...
int lua_fairygui_InputEvent_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::InputEvent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_InputEvent_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_InputEvent_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_InputEvent_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (InputEvent)");
    return 0;
}

int lua_register_fairygui_InputEvent(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"InputEvent");
        tolua_function(tolua_S,"new",lua_fairygui_InputEvent_constructor);
...
int lua_fairygui_EventContext_preventDefault(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_preventDefault'", nullptr);
            return 0;
        }
        cobj->preventDefault();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_EventContext_isDefaultPrevented(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_isDefaultPrevented'", nullptr);
            return 0;
        }
...
int lua_fairygui_EventContext_getType(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_getType'", nullptr);
            return 0;
        }
...
int lua_fairygui_EventContext_getSender(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_getSender'", nullptr);
            return 0;
        }
...
int lua_fairygui_EventContext_uncaptureTouch(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_uncaptureTouch'", nullptr);
            return 0;
        }
        cobj->uncaptureTouch();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_EventContext_getInput(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_getInput'", nullptr);
            return 0;
        }
...
int lua_fairygui_EventContext_captureTouch(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_captureTouch'", nullptr);
            return 0;
        }
        cobj->captureTouch();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_EventContext_stopPropagation(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_stopPropagation'", nullptr);
            return 0;
        }
...
int lua_fairygui_EventContext_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::EventContext* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_EventContext_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_EventContext_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_EventContext_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (EventContext)");
    return 0;
}

int lua_register_fairygui_EventContext(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EventContext");
        tolua_function(tolua_S,"new",lua_fairygui_EventContext_constructor);
...
int lua_fairygui_UIEventDispatcher_isDispatchingEvent(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_UIEventDispatcher_removeEventListeners(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIEventDispatcher* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIEventDispatcher_removeEventListeners'", nullptr);
            return 0;
        }
...
int lua_fairygui_UIEventDispatcher_dispatchEvent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIEventDispatcher* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_UIEventDispatcher_bubbleEvent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIEventDispatcher* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_UIEventDispatcher_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIEventDispatcher* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIEventDispatcher_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_UIEventDispatcher_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_UIEventDispatcher_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (UIEventDispatcher)");
    return 0;
}

int lua_register_fairygui_UIEventDispatcher(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"UIEventDispatcher");
        tolua_function(tolua_S,"new",lua_fairygui_UIEventDispatcher_constructor);
...
int lua_fairygui_UIPackage_getItemAsset_1(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::UIPackage* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_fairygui_UIPackage_getItemAsset'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_getItemAsset'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_UIPackage_getItemAsset'.",&tolua_err);
#endif
...
int lua_fairygui_UIPackage_createSprite(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 2)
    {
        std::string arg0;
        std::string arg1;
        ok &= luaval_to_std_string(tolua_S, 2,&arg0, "fgui.UIPackage:createSprite");
        ok &= luaval_to_std_string(tolua_S, 3,&arg1, "fgui.UIPackage:createSprite");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_createSprite'", nullptr);
            return 0;
        }
        cocos2d::Sprite* ret = fairygui::UIPackage::createSprite(arg0, arg1);
        object_to_luaval<cocos2d::Sprite>(tolua_S, "cc.Sprite",(cocos2d::Sprite*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "fgui.UIPackage:createSprite",argc, 2);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_UIPackage_createSprite'.",&tolua_err);
#endif
    return 0;
}
...
int lua_fairygui_UIPackage_getItemAssetByURL(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 1)
    {
        ...
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_UIPackage_getItemAssetByURL'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_UIPackage_getItemAssetByURL'.",&tolua_err);
#endif
    return 0;
}
...
int lua_fairygui_UIPackage_getItemAsset(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
...
int lua_register_fairygui_UIPackage(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"UIPackage");
        ...
        //tolua_function(tolua_S,"getItemAsset",lua_fairygui_UIPackage_getItemAsset);
        ...
        tolua_function(tolua_S,"createSprite", lua_fairygui_UIPackage_createSprite);
        ...
        tolua_function(tolua_S,"getItemAssetByURL", lua_fairygui_UIPackage_getItemAssetByURL);
...
int lua_fairygui_GTextField_setAutoSize(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GTextField_getFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_getFontSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_setColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextField_setSingleLine(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextField_isUBBEnabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_isUBBEnabled'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_getColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_getColor'", nullptr);
            return 0;
        }
        cocos2d::Color3B ret = cobj->getColor();
        color3b_to_luaval(tolua_S, ret);
...
int lua_fairygui_GTextField_setTemplateVars(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextField_setVar(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextField_getOutlineColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_getOutlineColor'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_setUBBEnabled(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextField_getTemplateVars(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_getTemplateVars'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_getAutoSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_getAutoSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_setFontSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextField_flushVars(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_flushVars'", nullptr);
            return 0;
        }
        cobj->flushVars();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_GTextField_applyTextFormat(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_applyTextFormat'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_setOutlineColor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GTextField_getTextFormat(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_getTextFormat'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_isSingleLine(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_isSingleLine'", nullptr);
            return 0;
        }
...
int lua_fairygui_GTextField_getTextSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GTextField* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GTextField_getTextSize'", nullptr);
            return 0;
        }
...
static int lua_fairygui_GTextField_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GTextField)");
    return 0;
}

int lua_register_fairygui_GTextField(lua_State* tolua_S)
{
...
int lua_fairygui_GComponent_getMargin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GComponent_getMargin'", nullptr);
            return 0;
        }
...
int lua_fairygui_GComponent_setMargin(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GComponent* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObjectPool_getObject(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GObjectPool_returnObject(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObjectPool* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GObjectPool_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GObjectPool* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GObjectPool_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GObjectPool_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GObjectPool_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GObjectPool)");
    return 0;
}

int lua_register_fairygui_GObjectPool(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GObjectPool");
        tolua_function(tolua_S,"new",lua_fairygui_GObjectPool_constructor);
...
int lua_fairygui_GScrollBar_setScrollPane(lua_State* tolua_S)
{
    int argc = 0;
...
int lua_fairygui_GScrollBar_setDisplayPerc(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GScrollBar* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GScrollBar_getMinSize(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GScrollBar* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GScrollBar_getMinSize'", nullptr);
            return 0;
        }
...
int lua_fairygui_GScrollBar_setScrollPerc(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GScrollBar* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_GScrollBar_create(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GScrollBar_create'", nullptr);
            return 0;
        }
...
int lua_fairygui_GScrollBar_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::GScrollBar* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_GScrollBar_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_GScrollBar_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_GScrollBar_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (GScrollBar)");
    return 0;
}

int lua_register_fairygui_GScrollBar(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"GScrollBar");
        tolua_function(tolua_S,"new",lua_fairygui_GScrollBar_constructor);
...
int lua_fairygui_DragDropManager_cancel(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DragDropManager_cancel'", nullptr);
            return 0;
        }
        cobj->cancel();
        lua_settop(tolua_S, 1);
...
int lua_fairygui_DragDropManager_isDragging(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DragDropManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DragDropManager_isDragging'", nullptr);
            return 0;
        }
...
int lua_fairygui_DragDropManager_getAgent(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DragDropManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DragDropManager_getAgent'", nullptr);
            return 0;
        }
...
int lua_fairygui_DragDropManager_startDrag(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DragDropManager* cobj = nullptr;
    bool ok  = true;
...
int lua_fairygui_DragDropManager_getInstance(lua_State* tolua_S)
{
    int argc = 0;
    bool ok  = true;
    ...
    if (argc == 0)
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DragDropManager_getInstance'", nullptr);
            return 0;
        }
...
int lua_fairygui_DragDropManager_constructor(lua_State* tolua_S)
{
    int argc = 0;
    fairygui::DragDropManager* cobj = nullptr;
    bool ok  = true;
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_fairygui_DragDropManager_constructor'", nullptr);
            return 0;
        }
...
#if COCOS2D_DEBUG >= 1
    tolua_error(tolua_S,"#ferror in function 'lua_fairygui_DragDropManager_constructor'.",&tolua_err);
#endif

    return 0;
}

static int lua_fairygui_DragDropManager_finalize(lua_State* tolua_S)
{
    printf("luabindings: finalizing LUA object (DragDropManager)");
    return 0;
}

int lua_register_fairygui_DragDropManager(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"DragDropManager");
        tolua_function(tolua_S,"new",lua_fairygui_DragDropManager_constructor);
